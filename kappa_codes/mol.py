...
class run_pyscf():
    ...
    def __init__(
        ...
        self.has_ghost_atoms = bool(ghost_atoms)  #check for ghost atoms 
    ...
    def _construct_atom_with_ghosts(self, real_atoms: str, ghost_atoms: str):
        ...
        # ghost atoms (prefix element with 'ghost-' or 'GHOST:')
        for line in ghost_coords:
            ...
            if line:
                ...
                if len(parts) >= 4:
                    ...
                    # PySCF accepts "ghost-Element" or "ghost.Element" syntax
    ...
    def run_mol(self, chkfile_name: str = "", chkfile_dir: str =""):
        ...
        # build the HF density matrix in the AO basis
    ...
    def run_eris_df(self, chkfile_name: str = "", chkfile_dir: str = "", auxbasis: str = ""):
        ...
        # Generate 3-index DF integrals
        # Auto-select auxiliary basis if not provided
        if not auxbasis:
            # Common auxiliary basis conventions
            if 'cc-pv' in self.basis.lower():
                auxbasis = self.basis.replace('cc-pv', 'cc-pv') + '-ri'
            elif 'def2' in self.basis.lower():
                auxbasis = self.basis + '/jkfit'
            else:
                auxbasis = 'weigend'  # Universal auxiliary basis
